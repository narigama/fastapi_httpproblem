    ...
    def __new__(cls, class_name, parents, attrs):  # noqa: D102
        ...
        def to_dict(self, request: fastapi.Request) -> dict:
            data = {
                ...
                "type": urllib.parse.urljoin(str(request.base_url), "problem/{}".format(self.kind)),
            }
...
def install_error_handler(app: fastapi.FastAPI, handle_uncaught: bool = True) -> fastapi.FastAPI:
